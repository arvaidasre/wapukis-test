...
export function AccessibleBuildingDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      ...
      >
        <DialogHeader>
          <DialogTitle id="building-dialog-title" className="flex items-center gap-2 text-xl">
                ...
                {laukoAugalai.length === 0 ? (
                  ...
                  >
                    ...
                    <Select value={selectedCrop} onValueChange={setSelectedCrop} aria-label="Augalo pasirinkimas">
                      <SelectTrigger id="crop-select" className="bg-white dark:bg-gray-800">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <Select value={selectedAnimal} onValueChange={setSelectedAnimal} aria-label="Gyvūno pasirinkimas">
                    <SelectTrigger id="animal-select" className="bg-white dark:bg-gray-800">
